...
# Directory stuff
mapping_dir = "mapping"
mapping_file = "artist-mapping.yaml"
...
with open(data_path, "r") as data_stream:
    ...
    for row in reader:
        ...
        # Serialize and output the fragment
        logging.info("Serializing the fragment.")
        output_file = f"output-{row['Game'].replace(' ', '')}.ttl"
